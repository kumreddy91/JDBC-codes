...
public class CountryCodes {
	 ...
	 //myNewHashMap is 'reverse-map' of original 'map'    
	 Map<String, String> myNewHashMap = new TreeMap<String,String>(String.CASE_INSENSITIVE_ORDER);
	//Country codes from internet	
	 public CountryCodes() {
	    ...
	    public String getCountryName(String countrycode){
	     String countryFound = myNewHashMap.get(countrycode);
	     if(countrycode.equals("HZGP")){
	    	 countryFound = "HANGZHOU ROAD AND BRIDGE GROUP";
	     }
	     else if(countryFound==null){
	             countryFound="Can't find";
	     }
	     return countryFound;
	     }
